...
public class Hybrid2 implements AIInterface {
	...
	public void processing() {
		// TODO Auto-generated method stub
		 if (this.frameData.getEmptyFlag() || this.frameData.getRemainingFramesNumber() <= 0) {
        	...
        	int action_num=4;
    		String gene="001110011011010011000100101001100010000001110001101000111011111111001010000010001110010100100100110000101110010000001110011100000000110101101111111001001000";
