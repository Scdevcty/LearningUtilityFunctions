...
public class Hybrid1 implements AIInterface {
	...
	public void processing() {
		// TODO Auto-generated method stub
		 if (this.frameData.getEmptyFlag() || this.frameData.getRemainingFramesNumber() <= 0) {
        	...
        	int action_num=4;
    		String gene="011011100111010010010110000101100000010010011001011011100011000001110000100100001101110100001010111111100010000100001000100001100100100101100110110100000001";
